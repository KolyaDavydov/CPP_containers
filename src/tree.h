...
namespace s21 {
  ...
  */
  ...
  class Node {
    ...
    Node(const T& key) : key(key), left(nullptr), right(nullptr), top(nullptr), is_min(false), is_max(false) {}
    Node(T& key) : key(key), left(nullptr), right(nullptr), top(nullptr), is_min(false), is_max(false) {}
  }; // end class Node
